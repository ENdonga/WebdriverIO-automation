...
exports.config = {
    ...
    before: function (capabilities, specs) {
        ...
        /**
         * This a user defined driver helper method.
         * The method accepts one argument of type selector(element) and performs a waitForExist and
         * then a click action.
         * If an exception is encountered in the process, the catch block handles the exception and throws
